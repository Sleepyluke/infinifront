...
- [ ] **R5-ART — Mycel building sprites** — 4 sprites (hollow/pit/bladder/barb) via nano-banana, fungal-organic look (bioluminescent, chitinous, spore-purple/sickly-green), keysprite chroma-key → `godot/assets/buildings/`.
